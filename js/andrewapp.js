async function predict() {
  ...
  const fighter2 = fighter2_el?.value
    ...
    const rawResponse = await fetch('https://newufcapp.herokuapp.com/predict', {
      method: 'POST',
      headers: {
...
function init() {
  d3.json("https://newufcapp.herokuapp.com/fighters").then(data => {
...
function fighter1() {
  ...
  d3.json(`https://newufcapp.herokuapp.com/ufc`).then(data => {
